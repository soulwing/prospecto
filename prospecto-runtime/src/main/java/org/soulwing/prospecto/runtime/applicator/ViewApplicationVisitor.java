...
public class ViewApplicationVisitor extends AbstractViewNodeVisitor {
  ...
  public Object visitSplice(SpliceNode node, Object state) {
    return new SpliceApplicator(node);
  }
  ...
  public Object visitMapOfObjects(MapOfObjectsNode node, Object state) {
    return new MapOfObjectsApplicator(node, (List<ViewEventApplicator>) state);
  }

  @Override
  @SuppressWarnings("unchecked")
  public Object visitMapOfReferences(MapOfReferencesNode node, Object state) {
    return new MapOfReferencesApplicator(node, (List<ViewEventApplicator>) state);
  }
