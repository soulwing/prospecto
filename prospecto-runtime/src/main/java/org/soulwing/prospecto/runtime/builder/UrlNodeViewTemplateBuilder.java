...
/**
 * A template builder for a URL node.
 *
 * @author Carl Harris
 */
class UrlNodeViewTemplateBuilder extends ValueNodeViewTemplateBuilder {

  private UnconfigurableNodeSupport delegate;

  UrlNodeViewTemplateBuilder(AbstractViewTemplateBuilder parent,
