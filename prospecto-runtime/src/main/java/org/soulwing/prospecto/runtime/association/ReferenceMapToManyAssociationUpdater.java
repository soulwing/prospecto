...
/**
 * A {@link ToManyAssociationUpdater} for a map of references.

 * @author Carl Harris
 */
public class ReferenceMapToManyAssociationUpdater
    extends ValueCollectionToManyAssociationUpdater {

  public static final ReferenceMapToManyAssociationUpdater INSTANCE =
      new ReferenceMapToManyAssociationUpdater();

  private ReferenceMapToManyAssociationUpdater() {
    super();
  }
  ...
  protected Object resolve(Object value,
    ...
    final Map.Entry<Object, InjectableViewEntity> entry =
        (Map.Entry<Object, InjectableViewEntity>) value;
