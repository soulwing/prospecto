...
/**
 * A template builder for a splice node.
 *
 * @author Carl Harris
 */
class SpliceNodeViewTemplateBuilder extends ValueNodeViewTemplateBuilder {

  private UnconfigurableNodeSupport delegate;

  SpliceNodeViewTemplateBuilder(AbstractViewTemplateBuilder parent,
